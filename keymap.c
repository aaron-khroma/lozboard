 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |   "  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |Lozzy | GUI  | Alt  |Leften|    Space    |Rightn| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, LOZENGE, KC_LGUI, KC_LALT, LEFTEN,  KC_SPC,  KC_SPC,  RIGHTEN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),

/* Lozenge (Custom Functions)
 * ,-----------------------------------------------------------------------------------.
 * |      |      |      |      |      |      |      |   7  |   8  |   9  |   +  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |   4  |   5  |   6  |   -  | Del  |
...
[_DVORAK] = LAYOUT_preonic_grid(
  ...
  BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LEFTEN,  KC_SPC,  KC_SPC,  RIGHTEN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case LOZENGE:
          if (record->event.pressed) {
            set_single_persistent_default_layer(_LOZENGE);
          }
          return false;
          break;
        case DVORAK:
        ...
        case LEFTEN:
          if (record->event.pressed) {
            layer_on(_LEFTEN);
            update_tri_layer(_LEFTEN, _RIGHTEN,_ADJUST);
          } else {
            layer_off(_LEFTEN);
            update_tri_layer(_LEFTEN, _RIGHTEN,_ADJUST);
          }
